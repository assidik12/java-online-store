...
public class TransactionDetailResponse {
    ...
    public TransactionDetailResponse(Integer id, String transactionId, Integer productId, String productName,
            Integer quantity, Integer totalPriceProduct) {
        this.id = id;
        ...
        this.formattedTotalPriceProduct = totalPriceProduct != null
                ? String.format("%,d", totalPriceProduct).replace(',', '.')
                : "0";
    }
